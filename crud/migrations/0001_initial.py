...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_name', models.CharField(default='Riyaz', max_length=30)),
                ('last_name', models.CharField(default='Muhammad', max_length=30)),
                ('dob', models.DateField(null=True)),
                ('email', models.CharField(default='@email.com', max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Instructor',
